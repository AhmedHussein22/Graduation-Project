...
class FABBottomAppBar extends StatefulWidget {
  ...
  const FABBottomAppBar({required this.selectedIndex});
  @override
    ...
    if (_selectedIndex != index) {
      ...
      switch (index) {
        ...
        case 1:
          ...
          break;
        case 2:
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ChatView(isStudent: true)));
          break;
        case 3:
